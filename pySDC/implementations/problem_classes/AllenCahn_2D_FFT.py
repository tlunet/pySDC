...
class allencahn2d_imex(ptype):
    ...
    def __init__(self, problem_params, dtype_u, dtype_f):
        ...
        self.xvalues = np.array([i * self.params.L / self.params.nvars[0] - self.params.L / 2.0
        ...
        self.fft_in = pyfftw.empty_aligned(self.init, dtype='complex128')
        self.fft_out = pyfftw.empty_aligned(self.init, dtype='complex128')
        self.ifft_in = pyfftw.empty_aligned(self.init, dtype='complex128')
        self.ifft_out = pyfftw.empty_aligned(self.init, dtype='complex128')
        self.fft_object = pyfftw.FFTW(self.fft_in, self.fft_out, direction='FFTW_FORWARD', axes=(0, 1))
        self.ifft_object = pyfftw.FFTW(self.ifft_in, self.ifft_out, direction='FFTW_BACKWARD', axes=(0, 1))
